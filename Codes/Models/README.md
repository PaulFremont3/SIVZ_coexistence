...
- As an example, data from full or part of Figure 3, Figure 4, Figure S6 and Figure S14 are stored in the folder `model_data` so they can be directly reproduced by running `python make_figures_scaled.py main_models`
