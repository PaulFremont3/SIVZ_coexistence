...
if __name__ == '__main__':
    ...
    if dz2==0:
        ...
        for k in to_plot:
            ...
            i1=0
            i2=round(365*5/dt)
            make_1_plot(S, V, R,Z, i1, i2, tit,dt,pp, Qp, Qv, Qz, ylab='Concentration (ind.L-1)', ymin=1, ymax=5e10)
            make_1_plot(S, V, R,Z, i1, i2, tit,dt,pp, 1, 1, 1, ylab='Concentration (umol.L-1)', ymin=1e-7, ymax=0.5)
    ...
    if nyears==20:
        write_matrix(exclusion_times, 'model_data/exclusion_times_SVRZ_'+suffix+'.txt', ' ')
        write_matrix(final_state_all  ,'model_data/state_reached_SVRZ_'+suffix+'.txt', ' ')
